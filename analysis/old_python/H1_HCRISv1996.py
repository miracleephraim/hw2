...
for year in range(1998, 2011):
    ...
    alpha_path = f"C:/Users/mirac/Documents/Github/econ470_ma/hw2/data/hosp_{year}_ALPHA.CSV"
    numeric_path = f"C:/Users/mirac/Documents/Github/econ470_ma/hw2/data/hosp_{year}_NMRC.CSV"
    report_path = f"C:/Users/mirac/Documents/Github/econ470_ma/hw2/data/hosp_{year}_RPT.CSV"
...
# Save final dataset
final_hcris_v1996.to_csv('C:/Users/mirac/Documents/Github/econ470_ma/hw2/data/HCRIS_v1996.csv', index=False)
