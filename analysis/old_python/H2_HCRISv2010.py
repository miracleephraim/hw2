...
for year in range(2010, 2017):
    ...
    hcris_alpha = pd.read_csv(f"C:/Users/mirac/Documents/Github/econ470_ma/hw2/data/hosp10_{year}_ALPHA.CSV", 
                              names=['RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'])
    hcris_numeric = pd.read_csv(f"C:/Users/mirac/Documents/Github/econ470_ma/hw2/data/hosp10_{year}_NMRC.CSV", 
                                names=['RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'])
    hcris_report = pd.read_csv(f"C:/Users/mirac/Documents/Github/econ470_ma/hw2/data/hosp10_{year}_RPT.CSV", 
...
final_hcris_v2010.to_csv("C:/Users/mirac/Documents/Github/econ470_ma/hw2/data/HCRIS_v2010.csv", index=False)
